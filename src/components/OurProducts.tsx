...
const OurProducts = () => {
  ...
  return (
    <section className="w-full min-h-[100vh] md:h-screen bg-[#3a3528] bg-[url('/material-definitivo/home-imagenes/fondo-ourproducts-mobile.png')] md:bg-[url('/fondos/PRODUCTOS.png')] bg-[length:100%_100%] bg-no-repeat bg-center flex flex-col items-center justify-center relative py-20 md:py-6 px-6 font-montserrat overflow-hidden">
